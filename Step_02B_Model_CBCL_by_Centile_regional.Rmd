...
This R Notebook runs multivariate multiple regression to model the effects of regional GMV on clinical outcomes using dimensional, tail sampled, and propensity matched modeling strategies. 
...
and merge into data:
```{r}
GMV_test_data2<- merge(unmatched_GMV_data, cbcl, by.x='subjectkey', by.y='src_subject_id')%>%
...
model_template<- 
'
cbcl_scr_dsm5_depress_r ~ {predictor} + age + sex.x + site_id + puberty_stage + ethnicity + race_3 + parent_education + combined_income + euler
cbcl_scr_dsm5_anxdisord_r ~ {predictor} + age + sex.x + site_id + puberty_stage + ethnicity + race_3 + parent_education + combined_income + euler
cbcl_scr_dsm5_adhd_r ~ {predictor} + age + sex.x + site_id + puberty_stage + ethnicity + race_3 + parent_education + combined_income + euler
cbcl_scr_dsm5_opposit_r ~ {predictor} + age + sex.x + site_id + puberty_stage + ethnicity + race_3 + parent_education + combined_income + euler
cbcl_scr_dsm5_conduct_r ~ {predictor} + age + sex.x + site_id + puberty_stage + ethnicity + race_3 + parent_education + combined_income + euler
cbcl_scr_dsm5_somaticpr_r ~ {predictor} + age + sex.x + site_id + puberty_stage + ethnicity + race_3 + parent_education + combined_income + euler
...
fit_model <- function(predictor) {
  ...
  results <- estimates %>%
    filter(op == "~" & lhs %in% c("cbcl_scr_dsm5_anxdisord_r", 
                                  "cbcl_scr_dsm5_depress_r",
                                  "cbcl_scr_dsm5_adhd_r",
                                  "cbcl_scr_dsm5_conduct_r",
                                  "cbcl_scr_dsm5_opposit_r", 
                                  "cbcl_scr_dsm5_somaticpr_r") & rhs %in% c(predictor, 'age', 'sex.x', 'site_id', 'puberty_stage',
...
#rename v's
results_html$dependent<- (factor(results_html$dependent, levels = c("cbcl_scr_dsm5_anxdisord_r", 
                                  "cbcl_scr_dsm5_depress_r",
                                  "cbcl_scr_dsm5_adhd_r",
                                  "cbcl_scr_dsm5_conduct_r",
                                  "cbcl_scr_dsm5_opposit_r", 
...
matched_regression_table <- matched_results_html %>%
  ...
  tab_header(
    title = "Table X. Regression results for models predicting clinical outcomes using regional cGM across 3 modeling frameworks, controlling for covaraites",
...
matched_regression_table %>%
  gtsave("cbcl_regional_matched_table.html")
```

Format tail-sampled data:
```{r}
#add significance
...
#rename v's
results_html2$dependent<- (factor(results_html2$dependent, levels = c("cbcl_scr_dsm5_anxdisord_r", 
                                  "cbcl_scr_dsm5_depress_r",
                                  "cbcl_scr_dsm5_adhd_r",
                                  "cbcl_scr_dsm5_conduct_r",
                                  "cbcl_scr_dsm5_opposit_r", 
...
tails_regression_table %>%
  gtsave("cbcl_regional_tails_table.html")
```
...
#rename v's
results_html3$dependent<- (factor(results_html3$dependent, levels = c("cbcl_scr_dsm5_anxdisord_r", 
                                  "cbcl_scr_dsm5_depress_r",
                                  "cbcl_scr_dsm5_adhd_r",
                                  "cbcl_scr_dsm5_conduct_r",
                                  "cbcl_scr_dsm5_opposit_r", 
...
dim_regression_table %>%
  gtsave("cbcl_regional_dim_table.html")
```
...
results$dependent<- (factor(results$dependent, levels = c("cbcl_scr_dsm5_anxdisord_r", 
                                  "cbcl_scr_dsm5_depress_r",
                                  "cbcl_scr_dsm5_adhd_r",
                                  "cbcl_scr_dsm5_conduct_r",
                                  "cbcl_scr_dsm5_opposit_r", 
...
results$dependent<- revalue(results$dependent, c("cbcl_scr_dsm5_anxdisord_r" = "Anxiety Symptoms", 
...
p_both_h
ggsave(file="FIGS/regional_cbcl_matched.svg", plot=p_both_h, width=10, height=8)
```
...
results2$dependent<- (factor(results2$dependent, levels = c("cbcl_scr_dsm5_anxdisord_r", 
                                  "cbcl_scr_dsm5_depress_r",
                                  "cbcl_scr_dsm5_adhd_r",
                                  "cbcl_scr_dsm5_conduct_r",
                                  "cbcl_scr_dsm5_opposit_r", 
...
results2$dependent<- revalue(results2$dependent, c("cbcl_scr_dsm5_anxdisord_r" = "Anxiety Symptoms", 
                                                 "cbcl_scr_dsm5_depress_r"="Depression Symptoms", 
                                                 "cbcl_scr_dsm5_adhd_r"= "ADHD Symptoms",
                                                 "cbcl_scr_dsm5_conduct_r"= "CD Symptoms", 
                                                 "cbcl_scr_dsm5_opposit_r"= "ODD Symptoms", 
...
ggsave(file="FIGS/regional_cbcl_tails.svg", plot=p_both_h2, width=10, height=8)
p_both_h2
```
...
results3$dependent<- (factor(results3$dependent, levels = c("cbcl_scr_dsm5_anxdisord_r", 
                                  "cbcl_scr_dsm5_depress_r",
                                  "cbcl_scr_dsm5_adhd_r",
                                  "cbcl_scr_dsm5_conduct_r",
                                  "cbcl_scr_dsm5_opposit_r", 
...
results3$dependent<- revalue(results3$dependent, c("cbcl_scr_dsm5_anxdisord_r" = "Anxiety Symptoms", 
                                                 "cbcl_scr_dsm5_depress_r"="Depression Symptoms", 
                                                 "cbcl_scr_dsm5_adhd_r"= "ADHD Symptoms",
                                                 "cbcl_scr_dsm5_conduct_r"= "CD Symptoms", 
                                                 "cbcl_scr_dsm5_opposit_r"= "ODD Symptoms", 
...
p_both_h3
ggsave(file="FIGS/regional_cbcl_dim.svg", plot=p_both_h3, width=10, height=8)
```

Add in one figure 
```{r}
dsm_fig<- ggarrange(p_both_h3, p_both_h2,p_both_h,  nrow=3, ncol=1, labels=c("Dimensional", "Tail-Sampled", "Propensity Matched"),
...
ggsave(file="FIGS/brain_cbcl_matched.svg", plot=match_brain, width=10, height=8)
``` 
...
ggsave(file="FIGS/brain_cbcl_tails.svg", plot=tail_brain, width=10, height=8)
```
...
ggsave(file="FIGS/brain_cbcl_dim.svg", plot=dim_brain, width=10, height=8)
```
